  ...
  body: [
    // --------------------------------------------------------------- 输入框类型
    {
      ...
      controls: [
        ...
        { type: "image", name: "f18", label: "上传图片", reciever: `${serverHost}/!/amis-api/curd-page@uploadFile` },
    ...
    // --------------------------------------------------------------- 不常用表单项
    {
      ...
      controls: [
        ...
        {
          type: "matrix", name: "f21", label: "矩阵选择", rowLabel: "人员",
          columns: [{ label: "篮球" }, { label: "美术" }, { label: "音乐" }], rows: [{ label: "张三" }, { label: "李四" }, { label: "王五" }],
        },
        { type: "transfer", name: "f31", label: "穿梭器", options: statusMapper },
        {
          type: "tabs-transfer", name: "f32", label: "组合穿梭器", inputClassName: WidthClassName.width48x, selectMode: "tree", options: [
    ...
    // --------------------------------------------------------------- 编辑器
    {
      ...
      controls: [
        ...
        {
          type: "editor", name: "f15", label: "代码编辑器", language: "json",
          value: JSON.stringify(statusMapper, null, 2), inputClassName: WidthClassName.width_unset,
        },
        { type: "diff-editor", name: "f16", label: "对比编辑器", value: "hello", diffValue: "hello world", inputClassName: WidthClassName.width_unset },
        { type: "submit", label: "提交", level: "primary" },
      ],
      api: {
        method: "post",
