  ...
  body: [
    // --------------------------------------------------------------- 支持的校验类型
    {
      ...
      controls: [
        ...
        { type: "text", name: "f7", label: "字母或数字", placeholder: "必须是字母或者数字", required: true, validations: { isAlphanumeric: true } },
        ...
        {
          type: "text", name: "f10", label: "长度限制", placeholder: "长度必须是6", required: true,
          validations: { isLength: 6 },
        },
        {
          type: "text", name: "f11", label: "长度限制", placeholder: "长度在6~10", required: true,
          validations: { minLength: 6, maxLength: 10 },
        },
        {
          type: "text", name: "f12", label: "数值限制", placeholder: "数值在6~10.5", required: true,
          validations: { minimum: 6, maximum: 10.5 },
        },
        {
          type: "text", name: "f13", label: "必须填AAA", placeholder: "必须填AAA", required: true,
          validations: { equals: "AAA" },
        },
        {
          type: "text", name: "f14", label: "密码", placeholder: "随意填密码", required: true,
        },
        {
          type: "text", name: "f15", label: "确认密码", placeholder: "必须与密码一致", required: true,
          validations: { equalsField: "f14" },
        },
        { type: "text", name: "f16", label: "Json", placeholder: "必须是合法的Json字符串", required: true, validations: { isJson: true } },
        { type: "text", name: "f17", label: "正则匹配", placeholder: "必须以“aaa”结尾", required: true, validations: { matchRegexp: /.+aaa$/ } },
        {
          type: "text", name: "f18", label: "自定义函数", placeholder: "自定义函数校验，只能填“a”、“b”、“c”",
