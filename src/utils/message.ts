 ...
 */
function unsubscribe<T = any>(key: SubscribeKey, handler?: Handler<T>) {
 ...
 * @param handler 监听函数
 */
function subscribeOnce<T = any>(key: string, handler: Handler<T>) {
 ...
 * @param message 消息值
 */
function publish<T = any>(key: SubscribeKey, message: T) {
